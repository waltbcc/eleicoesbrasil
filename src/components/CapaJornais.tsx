    ...
    return (
        <div className="  border-1 border-zinc-300 bg-gray-300 p-2 rounded-xl">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-2xl font-bold text-black mb-1 text-center">Capa dos Jornais do Dia</h1>
                <p className="text-gray-700 text-center mb-2">clique nas imagens para abri-las</p>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="mt-4 text-center">
                                <h2 className="text-2xl font-bold text-white">{selecionarImagem.title}</h2>
                                <p className="text-gray-300 mt-2">{selecionarImagem.description}</p>
                            </div>
                        </div>
                    </div>
                )}
